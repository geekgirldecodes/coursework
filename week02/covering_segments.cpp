...
void test(){
  ...
  // points for this test data shall include 2 points : 3 and 6 
  /*  uncomment block below for extra logging  */
  /*std::cout << points.size() << "\n";
  for (size_t i = 0; i < points.size(); ++i) {
    std::cout << points[i] << " ";
  } */

  // verify test case output
  assert(points.at(0) == 3);
  assert(points.at(1) == 6);
